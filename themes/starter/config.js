...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_URL: 'https://www.skablab.top/archive', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '关注Github', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://github.com/skablab', // 英雄区按钮
  STARTER_HERO_BUTTON_2_ICON: '/images/starter/github.svg', // 英雄区按钮2的图标，不需要则留空

  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/skablab.png', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_FEATURE_TEXT_2: '上海市麻醉与脑功能调控重点实验室于2022年获批，对标世界顶尖的生物医学领域研究机构。重点实验室以培养具有国际视野、原始创新、德才兼备的创新人才为目标，实行医工交叉、多学科融合、以服务国家大健康战略和临床为导向开展前沿科学研究。重点实验室凝练创新目标，优化科技布局，深化体制机制改革，核心竞争力稳步提高，聚焦影响麻醉安全与术后中远期转归的诸多科学问题，如麻醉机制、麻醉深度的精准监测和调控、围术期神经调控技术策略形成和应用推广、麻醉和病人情绪与手术创伤对脆弱脑功能的影响及其远期效应、基于大数据和人工智能的麻醉医学信息技术平台和智能化决策系统构建等，结合寻找相关的预测和治疗效果评价生物标记物，通过 RCT 临床研究探索有效的干预策略，进一步结合人工智能等领域的创新理论和技术，开展麻醉学前沿与交叉研究，丰富麻醉学内涵与创新临床诊疗策略。重点实验室的发展离不开政府部门、兄弟单位和社会各界朋友的关心支持，让我们携起手来，为推动我国的医学进步而共同努力！', // 特性
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'mzkzyg@126.com',
  ...
  STARTER_POST_REDIRECT_URL: 'https://www.skablab.top/', // 重定向域名
